...
public:
  ...
  // If your array hits the point at which it is less than ( not <= ) 1/4 full,
  // it should call this function. It should shrink such that the array is 2x as
  // big as the data. NOTE: shrink_to_fit does not do the checking of 1/4 full;
  ...
  // Purpose: returns true if arraylist contains x, return false otherwise
